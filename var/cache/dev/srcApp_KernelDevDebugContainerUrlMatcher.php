...
class srcApp_KernelDevDebugContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function __construct(RequestContext $context)
    {
        ...
        $this->staticRoutes = [
            ...
            '/admin/api/doc.json' => [[['_route' => 'app.swagger', '_controller' => 'nelmio_api_doc.controller.swagger'], null, ['GET' => 0], null, false, false, null]],
            '/admin/api/doc' => [[['_route' => 'app.swagger_ui', '_controller' => 'nelmio_api_doc.controller.swagger_ui'], null, ['GET' => 0], null, false, false, null]],
        ...
        $this->dynamicRoutes = [
            ...
            194 => [
                [['_route' => 'app_product_getproduct', '_controller' => 'App\\Controller\\ProductController::getProductAction'], ['id'], ['GET' => 0], null, false, true, null],
                ...
                [['_route' => 'app_product_updateproduct', '_controller' => 'App\\Controller\\ProductController::updateProductAction'], ['id'], ['PUT' => 0], null, false, true, null],
            ],
        ];
    }
}
